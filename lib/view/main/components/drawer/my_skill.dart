  ...
  Widget build(BuildContext context) {
    return const Column(
      ...
      children: [
        ...
        AnimatedLinearProgressIndicator(percentage: 0.5, title: 'Sql',image: 'assets/icons/dart.png'),
        AnimatedLinearProgressIndicator(percentage: 0.7, title: 'Data Structures',image: 'assets/icons/flutter.png'),
        AnimatedLinearProgressIndicator(percentage: 0.9, title: 'HTML',image: 'assets/icons/flutter.png'),
        AnimatedLinearProgressIndicator(percentage: 0.80, title: 'CSS',image: 'assets/icons/bloc.png'),
        AnimatedLinearProgressIndicator(percentage: 0.54, title: 'JavaScript',image: 'assets/icons/dart.png'),
      ],);
  }
}
